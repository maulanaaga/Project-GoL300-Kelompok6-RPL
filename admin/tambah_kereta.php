...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ka (KANama) VALUES (%s)",
...
?>
          ...
          <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
            <table>
              <tr valign="baseline">
                <td align="right"><div align="left"><strong>Nama Kereta:</strong></div></td>
                <td><input type="text" name="KANama" value="" size="32" /></td>
              </tr>
              <tr valign="baseline">
                <td align="right">&nbsp;</td>
