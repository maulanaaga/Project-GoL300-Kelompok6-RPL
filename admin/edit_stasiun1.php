...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE stasiun1 SET stasiunNama1=%s WHERE stasiunID1=%s",
...
?></p>
            ...
            <form action="<?php echo $editFormAction; ?>" method="post" id="form1">
              <table>
                <tr valign="baseline">
                  <td align="right"><div align="left"><strong>TerminaID1:</strong></div></td>
                  <td><?php echo $row_rsstasuin1['stasiunID1']; ?></td>
                </tr>
                <tr valign="baseline">
                  <td align="right"><div align="left"><strong>Nama Terminal:</strong></div></td>
                  <td><input type="text" name="stasiunNama1" value="<?php echo htmlentities($row_rsstasuin1['stasiunNama1'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
                </tr>
                <tr valign="baseline">
                  <td align="right">&nbsp;</td>
              ...
              <input type="hidden" name="stasiunID1" value="<?php echo $row_rsstasuin1['stasiunID1']; ?>" />
            </form>
            <p>&nbsp;</p>
