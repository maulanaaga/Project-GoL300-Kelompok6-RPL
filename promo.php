...
<head>
<title>Promo dan Berita</title><script>  
    ...
    <label for="search">Input Tujuan Anda...</label>
			...
			<div id="main" class="main">
				<div class="headline">
				  <h1>PROMO L300</h1>
				  <p>&nbsp; </p>
				  <br><a href="/"><img src="promo1.png" alt="" width="600" height=250" longdesc="" /></a></br>
				  <h1><p>Ayoo buruaaaaaaaannnnnnnn booking, lagi ada Promo mudik Lebaran Banda Aceh- Langsa Hanya Rp.100.000</p></h1>
				  
				  <br<a href="/"><img src="promo3.png" alt="" width="600" height=250" longdesc="" /></a></br>
				  <h1><p>Kabar Baik di bulan Baik khusus untuk anak Rantau, Diskon 30% untuk mahasiswa dari harga yang biasanyaaa, buruann booking di Go-L300</p></h1>
