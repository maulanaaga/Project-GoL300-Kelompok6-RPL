...
<head>
<title>Member Area</title><script>  
  ...
  <div class="sidebar" id="search_box">
    <label for="search">Input Tujuan Anda...</label>
			...
			<div id="main" class="main">
				<div class="headline">
				  <h1>Peta Jalur Transportasi Aceh</h1>
				  <p><img src="peta.jpg" width="600" height="400" longdesc="images/peta_jawa.png" /></p>
				  <p>Jalur - Jalur Trasnporasi yang dilewati berbagai transportasi dari darat, laut dan juga udara, inilah rute ataupun jalan yang di lewati setiap transportasi seperti pada gambar di atas.</p>
				  <br>
				  <p><img src="petaA.gif" width="600" height="400" longdesc="images/peta_sumatera.png" /></p>
